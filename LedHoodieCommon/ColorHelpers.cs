...
/// <summary>
/// Helper methods for working with Meadow colors.
/// </summary>
public static class ColorHelpers
{
    ...
    /// <summary>
    /// Using the provided Random (or using a new one, if null), generate a random HSV color (0..360 hue on full saturation and brightness).
    /// </summary>
    /// <param name="rand">The Random instance to use for generating the color. If null, a new Random will be created.</param>
    /// <returns>A random, bright Meadow Color.</returns>
